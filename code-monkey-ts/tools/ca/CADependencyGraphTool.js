...
exports.caDependencyGraphTool = exports.CADependencyGraphTool = void 0;
const zod_1 = require("zod");
const tools_1 = require("@langchain/core/tools");
const CATool_1 = require("./CATool");
const deps_1 = require("../deps");
const instrumentation_1 = require("../../instrumentation");
const ngraph_graph_1 = require("ngraph.graph");
const CADependencyGraphToolInputSchema = zod_1.z.object({
...
let CADependencyGraphTool = (() => {
    var _a;
    let _classSuper = CATool_1.CATool;
    let _instanceExtraInitializers = [];
    let __run_decorators;
    return _a = class CADependencyGraphTool extends _classSuper {
            constructor() {
                super();
                this.name = (__runInitializers(this, _instanceExtraInitializers), "ca_generate_dependency_graph");
                this.description = "Generate a dependency graph for Python files";
                this.argsSchema = CADependencyGraphToolInputSchema;
            }
            _run(input, runManager) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    const graph = (0, ngraph_graph_1.createGraph)();
                    for (const filePath of allFiles) {
                        const moduleName = (0, deps_1.getModuleName)(filePath);
                        const imports = yield this.parser.getImports(filePath);
        ...
        (() => {
            ...
            __run_decorators = [(0, instrumentation_1.instrument)("Tool._run", ["files", "modules"], { attributes: { tool: "CADependencyGraphTool" } })];
...
exports.CADependencyGraphTool = CADependencyGraphTool;
exports.caDependencyGraphTool = (0, tools_1.tool)({
