...
const renameFile = (0, util_1.promisify)(fs.rename);
function renameFileTool(oldPath, newPath) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const absoluteOldPath = path.resolve(oldPath);
            const absoluteNewPath = path.resolve(newPath);
            yield renameFile(absoluteOldPath, absoluteNewPath);
            return {
                success: true,
...
if (require.main === module) {
    (() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const result = yield renameFileTool(oldPath, newPath);
